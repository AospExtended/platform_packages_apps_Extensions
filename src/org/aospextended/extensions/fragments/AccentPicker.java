...
public class AccentPicker extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private void initView() {
        ...
        setForegroundDrawable("com.android.theme.color.extendedgreen", extendedGreenAccent);
        ...
        setForegroundDrawable("com.android.theme.color.elegantgreen", elegantGreenAccent);
    }
    ...
    private void setForegroundDrawable(String packagename, Button buttonAccent) {
        if (AEXUtils.isThemeEnabled(packagename)) {
