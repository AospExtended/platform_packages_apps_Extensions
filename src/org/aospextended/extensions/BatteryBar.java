...
public class BatteryBar extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBatteryBarColor.setNewPreviewColor(hexColor);
        ...
        hexColor = String.format("#%08x", (0xffffffff & intColor));
        mBatteryBarChargingColor.setNewPreviewColor(hexColor);
        ...
        hexColor = String.format("#%08x", (0xffffffff & intColor));
        mBatteryBarBatteryLowColor.setNewPreviewColor(hexColor);
