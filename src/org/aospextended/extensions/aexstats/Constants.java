...
public class Constants {
    public static final String BASE_URL= "https://api.aospextended.com/";
    ...
    public static final String LAST_AEX_FINGERPRINT = "lastBuildFingerprint";

    public static final String KEY_DEVICE = "ro.aex.device";
    public static final String KEY_MODEL = "ro.product.model";
    public static final String KEY_VERSION = "7.0";
