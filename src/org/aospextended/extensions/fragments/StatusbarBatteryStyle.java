...
public class StatusbarBatteryStyle extends SettingsPreferenceFragment implements OnPreferenceChangeListener, Indexable {
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.status_bar_battery_style;
                    result.add(sir);
                    return result;
                }
                 @Override
